...
def generate_script(max_tokens=1500):
    ...
    You can choose any horror theme. This is for one single orator.
    ...
    End of 6th scene you need to have a suspense/cliff hanger ending that will make the viewers curious
